...
public abstract interface FilmAPI {
    ...
    @org.jetbrains.annotations.Nullable()
    public abstract java.lang.Object getVideoForFilmById(@retrofit2.http.Path(value = "id")
    int id, @org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super com.example.absolute_cinema_app.data.models.filmsModels.VideoResponse> $completion);
